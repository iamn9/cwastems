...
class FillPermissionsForBinRelationship extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBinRelationship constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.bin-relationship',
            'admin.bin-relationship.index',
            'admin.bin-relationship.create',
            'admin.bin-relationship.show',
            'admin.bin-relationship.edit',
            'admin.bin-relationship.delete',
            'admin.bin-relationship.bulk-delete',
        ]);
