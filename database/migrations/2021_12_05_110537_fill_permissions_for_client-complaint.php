...
class FillPermissionsForClientComplaint extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForClientComplaint constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.client-complaint',
            'admin.client-complaint.index',
            'admin.client-complaint.create',
            'admin.client-complaint.show',
            'admin.client-complaint.edit',
            'admin.client-complaint.delete',
            'admin.client-complaint.bulk-delete',
        ]);
