...
class FillPermissionsForBinStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBinStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.bin-status',
            'admin.bin-status.index',
            'admin.bin-status.create',
            'admin.bin-status.show',
            'admin.bin-status.edit',
            'admin.bin-status.delete',
            'admin.bin-status.bulk-delete',
        ]);
