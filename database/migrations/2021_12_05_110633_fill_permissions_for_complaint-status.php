...
class FillPermissionsForComplaintStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComplaintStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.complaint-status.index',
            'admin.complaint-status.create',
            'admin.complaint-status.show',
            'admin.complaint-status.edit',
            'admin.complaint-status.delete',
            'admin.complaint-status.bulk-delete',
        ]);
